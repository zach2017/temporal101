...
import demo.temporal.model.ExtractedImageInfo;
 ...
 *
 * <p>
 * Supports JPEG, PNG, TIFF, BMP, GIF, and WebP. The underlying Tess4J library
 * shells out to the system-installed {@code tesseract} binary, so the host (or
 * Docker container) must have Tesseract and at least the {@code eng}
 * trained-data pack installed.</p>
 */
@ActivityInterface
public interface OcrActivities {

    /**
     * Run OCR on a single image file and write the recognised text to
     * {@code textOutputPath}.
     *
