 ...
 *
 * <p>
 * <b>Determinism:</b> this class follows Temporal's determinism rules — no
 * direct I/O, no {@code System.currentTimeMillis()}, no random. All
...
public class FileProcessingWorkflowImpl implements FileProcessingWorkflow {
    ...
    public FileProcessingResult processFile(FileProcessingRequest request) {
        ...
        try {
            ...
            if (cancelRequested) {
                return buildCancelled(request, startMs, tmpDir);
            }
    ...
    /**
     * Workflow code cannot use {@code java.nio.file.Path}, so we do it
     * manually.
     */
